...
//TODO: Rewrite required which formats the data from json to frontmatter.
...
export async function deleteFn(blogId: string) {
  ...
  //TODO: Check this out
  console.log(`https://api.github.com/repos/${blog.sites.fullName}/contents/blog/${blog.title}.mdx`)
